...
from no_vllm.src.search.node_minimal import Node
from no_vllm.src.core.eval_minimal import evaluate_against_gt, detect_answer_signal
from no_vllm.src.core.trace.schema import CallRecord
...
class MCTSMinimal:
    ...
    def _log_llm_call(
        ...
        *,
        ...
        include_engine_metrics: bool = False,
    ) -> None:
        ...
        if include_engine_metrics:
            if getattr(res, "engine_metrics_raw", None) is not None:
                merged_meta["engine_metrics_raw"] = res.engine_metrics_raw
            if getattr(res, "engine_metrics_delta", None) is not None:
                merged_meta["engine_metrics_delta"] = res.engine_metrics_delta
    ...
    def _log_batch_summary(
        ...
        *,
        ...
        meta = {
            ...
            "engine_metrics_raw": batch_result.batch_metrics_raw,
            "engine_metrics_delta": batch_result.batch_metrics_delta,
        }
        if extra_meta:
    ...
    def _generate_candidates(
        ...
        *,
        ...
        batch_metrics_raw = results[0].engine_metrics_raw if results else None
        batch_metrics_delta = results[0].engine_metrics_delta if results else None
